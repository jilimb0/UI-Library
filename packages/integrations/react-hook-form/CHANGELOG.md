...
- Updated dependencies [933635a]
  - @ui-construction-library/core@0.8.0

## 0.4.4

### Patch Changes

- @ui-construction-library/core@0.7.1
...
- update pre-push validation to use validate:platform and adjust validation scripts ([6977c2e](../../commit/6977c2e))
